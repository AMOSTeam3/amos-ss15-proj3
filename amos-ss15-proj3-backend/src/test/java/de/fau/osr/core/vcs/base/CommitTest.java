...
public class CommitTest {
    ...
    public void CommitConstructor_filesField_Test(){
        ...
        assertEquals("CommitFiles should be equal the initialization CommitFiles", commitFileList, commitToTest.getCommitFiles());
    }
    ...
    public void CommitConstructor_EverythingInitializedwithNull_EveryPropertyReturnsNull_Test(){
        ...
        assertEquals("Initialized with commitfiles = Null, files should return Null", null, commitToTest.getCommitFiles());
